...
public interface Level {
	/**
	 * Creates the new row of tiles at the top. Uses the current pattern of the
	 * board to create a single row of tiles. Universal parameters to keep
	 * consistency with other themes that may implement row, column, and
	 * timeRunning.
	 * 
	 * @param row
